...
output_folder_path = fullfile(this_folder_path, sprintf('%s-reduced-skeleton-retro', sample_date)) ;
...
trees_folder_path = sprintf('/groups/mousebrainmicro/mousebrainmicro/scripts/build-brain-retro/%s-reduced-skeleton-output/full', sample_date) ;
sample_folder_path = sprintf('/nrs/mouselight/SAMPLES/%s', sample_date) ;
skeleton_folder_path = sprintf('/groups/mousebrainmicro/mousebrainmicro/scripts/build-brain-retro/%s-reduced-skeleton', sample_date) ;
...
all_tree_xyzs_in_erhan_coords = ...
    compute_or_read_from_memo(output_folder_path, ...
                              'all_tree_xyzs_in_erhan_coords',  ...
                              @()(read_all_centerpoints_in_folder(trees_folder_path, '.swc'))) ;
