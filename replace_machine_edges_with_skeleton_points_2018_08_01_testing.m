...
output_folder_path = fullfile(this_folder_path, sprintf('%s-testing', sample_date)) ;
sprintf('/groups/mousebrainmicro/mousebrainmicro/cluster/%s/carver', sample_date) ;
...
skeleton_folder_path =  sprintf('/groups/mousebrainmicro/mousebrainmicro/cluster/Reconstructions/%s/prob0', sample_date) ;
