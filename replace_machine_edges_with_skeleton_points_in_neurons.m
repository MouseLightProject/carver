function result = replace_machine_edges_with_skeleton_points_in_neurons(neurons, skeleton_graph, skeleton_xyzs, spacing)
    ...
    result = ...
        cellfun(@(neuron)(replace_machine_edges_with_skeleton_points_in_neuron(neuron, skeleton_graph, skeleton_kd_tree, skeleton_xyzs, spacing)), ...
                neurons, ...
                'UniformOutput', false) ;
end
