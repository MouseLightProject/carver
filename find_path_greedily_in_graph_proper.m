function result = find_path_greedily_in_graph_proper(G, xyzs, source_id, target_id)
    % When this works, it's v fast, but predictably it sometimes get stuck. 
    max_path_nodes = 1000 ;
    ...
    for path_node_index = 2:max_path_nodes ,
        ...
        neighbor_ids = neighbors(G, current_node_id) ;
